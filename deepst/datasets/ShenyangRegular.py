...
from ..preprocessing import MinMaxNormalization_01 as MinMaxNormalization
...
# parameters
DATAPATH = "/home/csi/Git/HumanFlowPrediction/data/shenyang_regular/"
...
def load_data(T=48, nb_flow=2, len_closeness=None, len_period=None, len_trend=None, len_test=None,
    ...
    # load data
    data, timestamps = load_stdata(os.path.join(DATAPATH, 'shenyang_regular.h5'))
